    ...
    case "project.meta.update": {
      ...
      return {
        ...
        payload: {
          ...
          ...(command.nameHidden !== undefined ? { nameHidden: command.nameHidden } : {}),
    ...
    case "thread.turn.start": {
      ...
      const userMessageEvent: Omit<OrchestrationEvent, "sequence"> = {
        ...
        payload: {
          ...
          ...(command.message.metadata !== undefined ? { metadata: command.message.metadata } : {}),
          turnId: null,
          streaming: false,
          createdAt: command.createdAt,
          updatedAt: command.createdAt,
      ...
      const turnStartRequestedEvent: Omit<OrchestrationEvent, "sequence"> = {
        ...
        payload: {
          ...
          ...(command.providerCapabilities !== undefined
            ? { providerCapabilities: command.providerCapabilities }
            : {}),
    ...
    case "thread.session.set": {
      ...
      return {
        ...
        payload: {
          ...
          ...(command.completedTurn ? { completedTurn: command.completedTurn } : {}),
        },
      };
    }
