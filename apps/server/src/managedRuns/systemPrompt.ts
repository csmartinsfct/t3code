...
1. Call list_managed_runs to check what's already running.
2. If a matching project action exists, use launch_project_script to start it.
3. If no matching action exists, use propose_project_script to suggest one to the user.
