...
export const ClientSettingsSchema = Schema.Struct({
  ...
  diffWordWrap: Schema.Boolean.pipe(Schema.withDecodingDefault(() => true)),
...
export const OrchestrationPromptSettings = Schema.Struct({
  ...
  reReview: PromptDocumentV1.pipe(
    Schema.withDecodingDefault(() => ORCHESTRATION_PROMPT_SHIPPED_DEFAULTS.reReview),
  ),
