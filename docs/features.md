...
- Claude Fable 5, Opus 4.8, and Sonnet 5 expose `xhigh` effort between High
  and Max. Older Claude models do not advertise it, and stale `xhigh`
  selections fall back to High.
- Claude Fable 5, Opus 4.8, and Sonnet 5 use native 1M context model IDs;
  older Claude 1M selections use the Claude Code `[1m]` model-id suffix.
