...
- [Browser Tools](docs/browser-tools.md) — Per-project headless Chromium automation via `/api/browser`, `@ref` element IDs, 58 tools, vendored GStack Browser, architecture + known issues.
