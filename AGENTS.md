...
- [Overlay Surfaces](docs/overlays.md) — UI/runtime contract for menus, popovers, dialogs, sheets, command dialogs, and native overlay `WebContentsView` fallback behavior when the embedded browser is visible.
